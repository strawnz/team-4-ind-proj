  ...
  return (
    <>
      <article className="">
        ...
        <div className="">
          <h2 className="">Adventure for All Ages</h2>
          <p>
      ...
      <article className="">
        ...
        <div className="">
          <h2>You Will be Well Taken Care of</h2>
          <p>
      ...
      <article className="">
        ...
        <div className="">
          <h2 className="">Wander the World Over</h2>
          <p className="">
            {" "}
      ...
      <article className="">
        ...
        <div className="">
          <h2 className="">Convenience Mode Set to Max</h2>
          <p>
